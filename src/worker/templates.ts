...
export const BUILTIN_TEMPLATES: BuiltinTemplate[] = [
  {
    ...
    description: "Six frames: requirements, estimates, API, data model, high-level design, deep dives.",
    ops: [
      ...frameGrid(["1. Requirements", "2. Estimates", "3. API", "4. Data model", "5. High-level design", "6. Deep dives"]),
      { op: "add_note", text: "Functional:\n- \n- \n\nNon-functional:\n- scale:\n- latency:\n- consistency:\n- availability:", frame: "f0", size: "m" },
      { op: "add_note", text: "DAU:\nreads/s:\nwrites/s:\nstorage / yr:\nbandwidth:", frame: "f1", size: "m" },
      { op: "add_note", text: "POST /...\nGET /...", frame: "f2", size: "m" },
      { op: "add_note", text: "Entities, keys, access patterns", frame: "f3", size: "m" },
      { op: "add_note", text: "Bottlenecks · SPOFs · caching · sharding · failure modes", frame: "f5", size: "m" },
    ],
  },
  {
    ...
    ops: [
      { op: "add_node", ref: "client", label: "Client", shape: "ellipse", place: { at: { x: 0, y: 200 } } },
      { op: "add_node", ref: "cdn", label: "CDN", place: { above: "client", gap: 60 }, color: "gray" },
      ...
      { op: "add_node", ref: "cache", label: "Cache (Redis)", place: { above: "api", gap: 80 }, color: "red" },
      { op: "add_node", ref: "db", label: "Primary DB", shape: "ellipse", place: { right_of: "api" }, color: "green" },
      { op: "add_node", ref: "q", label: "Queue", place: { below: "api", gap: 80 }, color: "yellow" },
      { op: "add_node", ref: "worker", label: "Workers", place: { right_of: "q" }, color: "blue" },
      { op: "add_node", ref: "blob", label: "Object Storage", shape: "ellipse", place: { right_of: "worker" }, color: "green" },
  ...
  },
  {
    ...
    ops: [
      ...
      { op: "add_node", ref: "ids", label: "ID Generator", place: { above: "api", gap: 80 }, color: "violet" },
      { op: "add_node", ref: "cache", label: "Cache", place: { right_of: "api" }, color: "red" },
      { op: "add_node", ref: "db", label: "DB (primary)", shape: "ellipse", place: { right_of: "cache" }, color: "green" },
      { op: "add_node", ref: "rep", label: "Read replicas", shape: "ellipse", place: { below: "db", gap: 80 }, color: "green" },
  ...
  },
  {
    ...
    ops: [
      { op: "add_node", ref: "client", label: "Clients", shape: "ellipse", place: { at: { x: 0, y: 200 } } },
      { op: "add_node", ref: "gw", label: "WS Gateway", place: { right_of: "client" }, color: "blue" },
      { op: "add_node", ref: "svc", label: "Message Service", place: { right_of: "gw" }, color: "blue" },
      { op: "add_node", ref: "pubsub", label: "Pub/Sub", place: { below: "gw", gap: 80 }, color: "yellow" },
      { op: "add_node", ref: "store", label: "Message Store", shape: "ellipse", place: { right_of: "svc" }, color: "green" },
      { op: "add_node", ref: "push", label: "Push Notifications", place: { below: "svc", gap: 80 }, color: "orange" },
